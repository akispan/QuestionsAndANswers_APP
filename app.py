...
app = Flask(__name__)
app.config['SECRET_KEY'] = os.urandom(24)  # random 24-digit ASCII number generation
...
def unanswered():
    ...
    guestions = question_cur.fetchall()

    return render_template('unanswered.html', user=user, questions=guestions)
